...
def main():
    ...
    generate_parser.add_argument("--report", action="store_true", help="生成 Markdown 早报")
    generate_parser.add_argument("--voice", action="store_true", help="生成语音播报稿")
    generate_parser.add_argument("--tts", action="store_true", help="生成语音音频（需要 MIMO_API_KEY）")
    generate_parser.add_argument("--dry-run", action="store_true", help="模拟运行，不标记文章为已推送")
    ...
    run_parser.add_argument("--tts", action="store_true", help="生成语音音频（需要 MIMO_API_KEY）")
    run_parser.add_argument("--dry-run", action="store_true", help="模拟运行，不标记文章为已推送")
